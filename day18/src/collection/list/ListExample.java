...
public class ListExample {
	...
	public static void main(String[] args) {
		// ArrayList와 LinkedList의 사용 양식은 전부 List를 따름
		// 따라서 교환 가능. 인터페이스가 같은 구현체들은 사용법이 같음
		// 제네릭: 타입 안정화를 위해 객체 내부에 저장되는 타입을 일치시키는 방법
		// String만 저장할 수 있는 컬렉션
//		List<String> list = new ArrayList<>(); // 1.8부터는 생성자에 제네릭 표기 하지 않아도 됨
